...
const Hero = () => {
  ...
  return (
    <>
      <Head>
        {/* preload изображения пены */}
        <link rel="preload" as="image" href="/foam.avif" />
      </Head>
      ...
      <div className={styles.hero}>
        ...
        <div className={`${styles.hSection} ${styles.left}`}>
          ...
          >
            ...
            <motion.p variants={awardVariants}>
              ...
              генерации текстов, улучшения дизайна и повышения
              производительности.
            </motion.p>
        ...
        <div className={styles.bg}>
          <Canvas>
            <Suspense fallback={null}>{ready && <Shape />}</Suspense>
          </Canvas>
